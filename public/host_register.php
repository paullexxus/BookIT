    ...
    elseif (!preg_match('/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[\W_]).{8,}$/', $password)) {
        ...
        if (!isset($error)) {
            ...
            $query = "INSERT INTO users (full_name, email, password, phone, role, condo_name, branch_name, condo_address, social_media, valid_id1, valid_id2, status) 
                     VALUES ('$host_name', '$email', '$hashed_password', '$phone', 'manager', '$condo_name', '$branch_name', '$condo_address', '$social_media', '$valid_id1_path', '$valid_id2_path', 'pending')";
...
<body>
                    ...
                    <div class="register-body">
                        <div class="text-center mb-4">
                            <h2 class="fw-bold text-primary">
                                <i class="fas fa-user-tie"></i> Host Registration
                            </h2>
                        ...
                        <form action="" method="POST" id="registerForm" enctype="multipart/form-data">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="host_name" name="host_name" 
                                       placeholder="Host Name" required value="<?php echo isset($_POST['host_name']) ? $_POST['host_name'] : ''; ?>">
                                <label for="host_name">
    ...
    <script src="../assets/js/public/host_register.js"></script>
</body>
</html>